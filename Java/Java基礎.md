## スレッドセーフ
- threadとは？ **すべての処理はスレッドの上で動く** main関数内でthreadが実行されている。
>スレッドとは、プログラムの中のひとまとまりの処理の単位のこと。
>このスレッドが1列で順番に処理されていくことを、シングルスレッドという。
>これに対して、スレッドが2列以上あり、複数の処理が並列に同時進行で処理されていくことをマルチスレッドという。
>javaは複数のスレッドを同時実行させて並列処理（マルチスレッド）を可能

<img src="https://github.com/kuro-channel/TIL/blob/master/Java/%E3%82%B9%E3%83%AC%E3%83%83%E3%83%88%E3%82%99.png?raw=true" alt="スレッド" title="スレッド">
